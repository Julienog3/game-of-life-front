<template>
    <div class="flex justify-between border-b border-gray-200 pb-8">
      ...
      <div v-if="textBtn && url" class="flex items-center gap-x-2 rounded p-4 bg-primary text-white h-fit">
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect width="18" height="18" fill="#404040"/>
        ...
        <Router-link :to="url"><button>Ajouter un {{textBtn}}</button></Router-link>
      </div>
    </div>
</template>
<script>
